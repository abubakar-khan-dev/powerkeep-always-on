  ...
  <section id="contact" className="py-20 bg-section-alt">
    <div className="container max-w-3xl">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        {[
          { icon: Phone, label: "WhatsApp", value: "+92 342 4100307" },
          { icon: Mail, label: "Email", value: "rawaanstore11@gmail.com" },
          { icon: MapPin, label: "Delivery", value: "All across Pakistan" },
        ].map((c, i) => (
          <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
            className="bg-card border border-border rounded-2xl p-6 text-center shadow-product"
          >
